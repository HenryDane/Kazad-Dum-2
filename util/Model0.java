...
public class Model0 {
    ...
    public static class Face {
        ...
        private Model0.Material material;

        public Model0.Material getMaterial() {
            return material;
        }
        ...
        public Face(int[] vertexIndices, int[] normalIndices, int[] textureCoordinateIndices, Model0.Material material) {
            this.vertexIndices[0] = vertexIndices[0];
            this.vertexIndices[1] = vertexIndices[1];
            this.vertexIndices[2] = vertexIndices[2];
